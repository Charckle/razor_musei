...
class Config(object):
    ...
    ADMIN_USERNAME = environ.get('RMUSEI_ADMIN_USERNAME', "admin")
    # SHA512
    # banana
    ADMIN_PASS_HASH = environ.get('RMUSEI_ADMIN_PASS_HASH', "$6$rounds=656000$fwae7LSkwByBpb.3$aHJHT/14VpH3lWIMK9TllW10WK3qi5D5fHvF9JzH6f588ly/GX/j9ojs7mDt/RHgLTAfmEZezob87x/SlKElT/")
